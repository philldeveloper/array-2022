...
<header class="p-5">
  <div class="container bg-banner" >
      <div class="row p-2 pb-0 pe-lg-0 align-items-center shadow-lg">
        <div class="col-lg-7 p-3 ps-lg-5 p-lg-4 pt-lg-4">
          <h3 class="lh-1 outfit-font fw-500 text-light">PACOTE</h3>
          <h1 class="display-4 lh-1 orbitron-font fw-500 text-light" style="letter-spacing: 3px">Programador do Futuro</h1>
...
<section class="container p-0 pb-5" id="content">
  <h2 class="outfit-font fw-500 title-success py-3 mb-5 ps-3">PROCURE POR CATEGORIA</h2>

  <div class="row p-0">
    <div class="col-lg-2 col-md-4 col-sm-12 card bg-transparent border-0">
